 ...
 * @var arteam\auth\models\forms\RegistrationForm $model
 */
$this->title = Yii::t('arteam/auth', 'Signup');
        ...
        <div class="col-md-<?= $col6 ?> col-md-offset-<?= $col3 ?>">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?= Html::submitButton(Yii::t('arteam/auth', 'Signup'), ['class' => 'btn btn-lg btn-primary btn-block']) ?>

                    <div class="row registration-block">
                        <div class="col-sm-<?= $col6 ?>">
                            <?= Html::a(Yii::t('arteam/auth', "Login"), ['default/login']) ?>
                        </div>
