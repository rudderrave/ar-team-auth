 ...
 * @var arteam\auth\models\forms\UpdatePasswordForm $model
 */
$this->title = Yii::t('arteam/auth', 'Update Password');
            ...
            <div class="col-md-<?= $col6 ?> col-md-offset-<?= $col3 ?>">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?= Html::submitButton(Yii::t('arteam', 'Update'), ['class' => 'btn btn-lg btn-primary btn-block']) ?>
