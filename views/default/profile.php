...
use arteam\auth\assets\AvatarUploaderAsset;
use arteam\auth\widgets\AuthChoice;
 ...
 * @var arteam\auth\models\forms\SetEmailForm $model
 */
$this->title = Yii::t('arteam/auth', 'User Profile');
...
<div class="profile-index">
    ...
    <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="text-right col-md-<?= $col3 ?>">
            <?= Html::a(Yii::t('arteam/auth', 'Update Password'), ['/auth/default/update-password'], ['class' => 'btn btn-primary btn-sm']) ?>
        </div>
    </div>
            ...
            <div class="image-uploader">
                ...
                <div class="image-actions">
                    <span class="btn btn-primary btn-file"
                          title="<?= Yii::t('arteam/auth', 'Change profile picture') ?>" data-toggle="tooltip"
                          data-placement="left">
                    ...
                    Html::submitButton('<i class="fa fa-save fa-lg"></i>', [
                        ...
                        'title' => Yii::t('arteam/auth', 'Save profile picture'),
                        'data-toggle' => 'tooltip',
                        'data-placement' => 'top',
                    ])
                    ?>
                    ...
                    <span class="btn btn-primary image-remove"
                          ...
                          title="<?= Yii::t('arteam/auth', 'Remove profile picture') ?>" data-toggle="tooltip"
            ...
            <div class="oauth-services">
                <div class="oauth-authorized-services">
                    <div class="label label-primary space-down"
                         title="<?= Yii::t('arteam/auth', 'Click to unlink service') ?>" data-toggle="tooltip"
                         data-placement="right">
                        <?= Yii::t('arteam/auth', 'Authorized Services') ?>:
                    </div>
                ...
                <div>
                    <div class="label label-primary space-down"
                         title="<?= Yii::t('arteam/auth', 'Click to connect with service') ?>" data-toggle="tooltip"
                         data-placement="right">
                        <?= Yii::t('arteam/auth', 'Non Authorized Services') ?>:
                    </div>
        ...
        <div class="col-md-<?= $col9 ?>">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-<?= $col3 ?>">
                            <?= $form->field($model, 'gender')->dropDownList(arteam\models\User::getGenderList()) ?>
                        </div>
                    </div>
            ...
            <?= Html::submitButton(Yii::t('arteam/auth', 'Save Profile'), ['class' => 'btn btn-primary']) ?>
...
<?php
$confRemovingAuthMessage = Yii::t('arteam/auth', 'Are you sure you want to unlink this authorization?');
$confRemovingAvatarMessage = Yii::t('arteam/auth', 'Are you sure you want to delete your profile picture?');
$js = <<<JS
