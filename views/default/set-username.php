 ...
 * @var arteam\auth\models\forms\SetUsernameForm $model
 */
$this->title = Yii::t('arteam/auth', 'Set Username');
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-<?= $col3 ?> col-sm-<?= $col9 ?>">
                            <?= Html::submitButton(Yii::t('arteam', 'Confirm'), ['class' => 'btn btn-lg btn-primary btn-block']) ?>
                        </div>
                    </div>
